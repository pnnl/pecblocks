...
if __name__ == '__main__':
  ...
  model.loadAndApplyNormalization(os.path.join(model_folder,'pv1_fhf_poly.json'))
  model.initializeModelStructure()
#  model.loadModelCoefficients(model_folder)
  model.load_sim_config (os.path.join(model_folder,'pv1_fhf_poly.json'), model_only=True)
