...
# file: Lab2TrainingPlot.py
""" Plots the Lab2 training data from HDF5 files.
...
plot_defs = [
    ...
    {'row':0, 'col':1, 'tag':'Rc',   'title':'Load Resistance',   'ylabel':'Ohm'},# 'scale':20.0, 'offset':50.0},
    {'row':0, 'col':2, 'tag':'Vc',   'title':'Control Voltage',   'ylabel':'V'},  # 'scale':12.0, 'offset':120.0},
