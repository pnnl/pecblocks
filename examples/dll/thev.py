...
cases = [
  {
    'model': '../hwpv/ucfB_t_2nd_Ctrl/ucfB_t_2nd_Ctrl_fhf.json',
    'tmax': 8.0,
    'kGIrms': 1.0,
    ...
    'Fc': [[-1.0, 100.0],
           [60.0, 60.0]],
    'Ctl':[[-1.0,0.0, 1.8, 100.0],
           [0.0, 0.0, 1.0, 1.0]],
    'Ud': [[-1.0, 6.0, 6.010, 100.0], 
           [1.05, 1.05, 1.17, 1.17]],
    'Uq': [[-1.0, 8.0, 8.010, 100.0], 
           [0.051, 0.051, 0.051, 0.051]],
    'Rg': [[-1.0, 4.0,   4.010, 100.0], 
           [100.0, 100.0, RGRID, RGRID]]
  },
  {
    'model': '../hwpv/ucfB_t_2nd_Step/ucfB_t_2nd_Step_fhf.json',
    'tmax': 8.0,
    'kGIrms': 1.0,
    'G':  [[-1.0, 0.1, 1.1,    2.0,   3.0, 100.0], 
           [0.0, 0.0, 900.0, 900.0, 850.0, 850.0]],
  ...
  {
    'model': '../hwpv/ucfB_t_2nd_Ramp/ucfB_t_2nd_Ramp_fhf.json',
    'tmax': 8.0,
    'kGIrms': 1.0,
    'G':  [[-1.0, 0.1, 1.1,    2.0,   3.0, 100.0], 
           [0.0, 0.0, 900.0, 900.0, 850.0, 850.0]],
  ...
  {
    'model': '../hwpv/ucf4tsx2nd/ucf4tsx2nd_fhf.json',
    'tmax': 8.0,
    'kGIrms': 1.0,
    'G':  [[-1.0, 0.1, 1.1,    2.0,   3.0, 100.0], 
           [0.0, 0.0, 900.0, 900.0, 850.0, 850.0]],
