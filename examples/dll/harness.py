...
cases = [
  {
    'model': '../hwpv/ucf4siir/ucf4siir_fhf.json',
    'tmax': 2.0,
    'kGVrms': 1.0,
    'G':  [[-1.0, 0.1, 1.1, 100.0], 
           [0.0, 0.0, 999.0, 999.0]],
  ...
  {
    'model': '../hwpv/ucf4s2nd/ucf4s2nd_fhf.json',
    'tmax': 2.0,
    'kGVrms': 1.0,
    'G':  [[-1.0, 0.1, 1.1, 100.0], 
           [0.0, 0.0, 999.0, 999.0]],
  ...
  {
    'model': '../hwpv/ucf10c2ndx/ucf10c2ndx_fhf.json',
    'tmax': 4.0,
    'kGVrms': 1.0,
    'G':  [[-1.0, 0.1, 1.1, 100.0], 
           [0.0, 0.0, 950.0, 950.0]],
  ...
  {
    'model': '../hwpv/ucf10ciir/ucf10ciir_fhf.json',
    'tmax': 4.0,
    'kGVrms': 1.0,
    'G':  [[-1.0, 0.1, 1.1, 100.0], 
           [0.0, 0.0, 950.0, 950.0]],
  ...
  {
    'model': '../hwpv/ucf10ciirsens/ucf10ciirsens_fhf.json',
    'tmax': 4.0,
    'kGVrms': 1.0,
    'G':  [[-1.0, 0.1, 1.1, 100.0], 
           [0.0, 0.0, 950.0, 950.0]],
  ...
  },
  {
    ...
    'tmax': 14.0,
    'kGVrms': 1.0,
    'G':  [[-1.0, 0.1,   1.1,   8.0,   8.5, 100.0], 
           [ 0.0, 0.0, 950.0, 950.0, 800.0, 800.0]],
    'T':  [[-1.0, 100.0],
           [35.0, 35.0]],
    'Fc': [[-1.0, 100.0],
           [60.0, 60.0]],
    'Ctl':[[-1.0, 1.8, 2.510, 100.0],
           [0.0, 0.0, 1.0, 1.0]],
    'Ud': [[-1.0, 4.0, 4.010, 100.0], 
           [0.999995, 0.999995, 1.1, 1.1]],
    'Uq': [[-1.0, 6.0, 6.010, 100.0], 
           [0.001, 0.001, -0.1, -0.2]],
    'Rg': [[-1.0, 10.0, 11.0, 100.0], 
           [95.0, 95.0, 80.0,  80.0]]
  },
  {
  ...
  {
    'model': '../hwpv/ucf7s2ndx/ucf7s2ndx_fhf.json',
    'tmax': 2.0,
    'kGVrms': 1.0,
    'G':  [[-1.0, 0.1, 1.1, 100.0], 
           [0.0, 0.0, 950.0, 950.0]],
