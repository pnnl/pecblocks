...
# print (sub_ctl)
  ...
  print ('     t    Vrms      G    GVrms    T    Ud    Fc    Vdc    Idc   Irms         Vs         Is')
  while ts <= tmax:
...
#      print ('  new G')
    ...
    print ('{:6.3f} {:7.3f} {:6.1f} {:8.2f} {:4.1f} {:5.3f} {:5.2f} {:6.2f} {:6.2f} {:6.2f} {:6.2f} {:6.2f}'.format(
      ts, Vrms, G, GVrms, T, Ud, Fc, vdc, idc, irms, Vs, Is))
